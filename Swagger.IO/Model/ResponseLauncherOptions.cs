...
namespace IO.Swagger.Model
{
    ...
    public partial class ResponseLauncherOptions :  IEquatable<ResponseLauncherOptions>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ResponseLauncherOptions);
        }

        /// <summary>
        /// Returns true if ResponseLauncherOptions instances are equal
        /// </summary>
        /// <param name="other">Instance of ResponseLauncherOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResponseLauncherOptions other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
