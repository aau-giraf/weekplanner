...
namespace IO.Swagger.Model
{
    ...
    public partial class ResponseLauncherOptionsDTO :  IEquatable<ResponseLauncherOptionsDTO>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ResponseLauncherOptionsDTO);
        }

        /// <summary>
        /// Returns true if ResponseLauncherOptionsDTO instances are equal
        /// </summary>
        /// <param name="other">Instance of ResponseLauncherOptionsDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResponseLauncherOptionsDTO other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
