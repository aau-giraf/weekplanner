...
namespace IO.Swagger.Model
{
    ...
    public partial class ResponseChoiceDTO :  IEquatable<ResponseChoiceDTO>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ResponseChoiceDTO);
        }

        /// <summary>
        /// Returns true if ResponseChoiceDTO instances are equal
        /// </summary>
        /// <param name="other">Instance of ResponseChoiceDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResponseChoiceDTO other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
