...
namespace IO.Swagger.Model
{
    ...
    public partial class ResponsePictogramDTO :  IEquatable<ResponsePictogramDTO>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ResponsePictogramDTO);
        }

        /// <summary>
        /// Returns true if ResponsePictogramDTO instances are equal
        /// </summary>
        /// <param name="other">Instance of ResponsePictogramDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResponsePictogramDTO other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
