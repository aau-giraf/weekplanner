...
namespace IO.Swagger.Model
{
    ...
    public partial class ResponseDepartmentDTO :  IEquatable<ResponseDepartmentDTO>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ResponseDepartmentDTO);
        }

        /// <summary>
        /// Returns true if ResponseDepartmentDTO instances are equal
        /// </summary>
        /// <param name="other">Instance of ResponseDepartmentDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResponseDepartmentDTO other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
