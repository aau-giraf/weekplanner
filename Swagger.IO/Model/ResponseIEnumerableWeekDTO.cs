...
namespace IO.Swagger.Model
{
    ...
    public partial class ResponseIEnumerableWeekDTO :  IEquatable<ResponseIEnumerableWeekDTO>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ResponseIEnumerableWeekDTO);
        }

        /// <summary>
        /// Returns true if ResponseIEnumerableWeekDTO instances are equal
        /// </summary>
        /// <param name="other">Instance of ResponseIEnumerableWeekDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResponseIEnumerableWeekDTO other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
