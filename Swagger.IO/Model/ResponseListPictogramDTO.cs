...
namespace IO.Swagger.Model
{
    ...
    public partial class ResponseListPictogramDTO :  IEquatable<ResponseListPictogramDTO>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ResponseListPictogramDTO);
        }

        /// <summary>
        /// Returns true if ResponseListPictogramDTO instances are equal
        /// </summary>
        /// <param name="other">Instance of ResponseListPictogramDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResponseListPictogramDTO other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
