...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ResponseChoiceDTO :  IEquatable<ResponseChoiceDTO>, IValidatableObject
    {
        /// <summary>
        /// Defines ErrorKey
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ResponseChoiceDTO" /> class.
        /// </summary>
        /// <param name="Data">Data.</param>
        /// <param name="Success">Success.</param>
        /// <param name="ErrorProperties">ErrorProperties.</param>
        public ResponseChoiceDTO(ChoiceDTO Data = default(ChoiceDTO), bool? Success = default(bool?), List<string> ErrorProperties = default(List<string>))
        {
            this.Data = Data;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResponseChoiceDTO {\n");
        ...
        {
            return this.Equals(input as ResponseChoiceDTO);
        }

        /// <summary>
        /// Returns true if ResponseChoiceDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of ResponseChoiceDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResponseChoiceDTO input)
        {
            if (input == null)
                return false;
