...
namespace IO.Swagger.Model
{
    ...
    public partial class ResponseGirafUserDTO :  IEquatable<ResponseGirafUserDTO>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as ResponseGirafUserDTO);
        }

        /// <summary>
        /// Returns true if ResponseGirafUserDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of ResponseGirafUserDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResponseGirafUserDTO input)
        {
            if (input == null)
                return false;
