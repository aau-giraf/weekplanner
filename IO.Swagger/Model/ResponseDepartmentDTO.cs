...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ResponseDepartmentDTO :  IEquatable<ResponseDepartmentDTO>, IValidatableObject
    {
        /// <summary>
        /// Defines ErrorKey
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ResponseDepartmentDTO" /> class.
        /// </summary>
        /// <param name="Data">Data.</param>
        /// <param name="Success">Success.</param>
        /// <param name="ErrorProperties">ErrorProperties.</param>
        public ResponseDepartmentDTO(DepartmentDTO Data = default(DepartmentDTO), bool? Success = default(bool?), List<string> ErrorProperties = default(List<string>))
        {
            this.Data = Data;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResponseDepartmentDTO {\n");
        ...
        {
            return this.Equals(input as ResponseDepartmentDTO);
        }

        /// <summary>
        /// Returns true if ResponseDepartmentDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of ResponseDepartmentDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResponseDepartmentDTO input)
        {
            if (input == null)
                return false;
