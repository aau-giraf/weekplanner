...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ResponseImageDTO :  IEquatable<ResponseImageDTO>, IValidatableObject
    {
        /// <summary>
        /// Defines ErrorKey
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ResponseImageDTO" /> class.
        /// </summary>
        /// <param name="Data">Data.</param>
        /// <param name="Success">Success.</param>
        /// <param name="ErrorProperties">ErrorProperties.</param>
        public ResponseImageDTO(ImageDTO Data = default(ImageDTO), bool? Success = default(bool?), List<string> ErrorProperties = default(List<string>))
        {
            this.Data = Data;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResponseImageDTO {\n");
        ...
        {
            return this.Equals(input as ResponseImageDTO);
        }

        /// <summary>
        /// Returns true if ResponseImageDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of ResponseImageDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResponseImageDTO input)
        {
            if (input == null)
                return false;
