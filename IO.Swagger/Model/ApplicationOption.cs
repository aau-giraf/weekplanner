...
namespace IO.Swagger.Model
{
    ...
    public partial class ApplicationOption :  IEquatable<ApplicationOption>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as ApplicationOption);
        }

        /// <summary>
        /// Returns true if ApplicationOption instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationOption to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationOption input)
        {
            if (input == null)
                return false;
