...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ResponseSettingDTO :  IEquatable<ResponseSettingDTO>, IValidatableObject
    {
        /// <summary>
        /// Defines ErrorKey
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ResponseSettingDTO" /> class.
        /// </summary>
        /// <param name="Data">Data.</param>
        /// <param name="Success">Success.</param>
        /// <param name="ErrorProperties">ErrorProperties.</param>
        public ResponseSettingDTO(SettingDTO Data = default(SettingDTO), bool? Success = default(bool?), List<string> ErrorProperties = default(List<string>))
        {
            this.Data = Data;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResponseSettingDTO {\n");
        ...
        {
            return this.Equals(input as ResponseSettingDTO);
        }

        /// <summary>
        /// Returns true if ResponseSettingDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of ResponseSettingDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResponseSettingDTO input)
        {
            if (input == null)
                return false;
