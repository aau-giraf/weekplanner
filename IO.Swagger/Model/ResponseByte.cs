...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ResponseByte :  IEquatable<ResponseByte>, IValidatableObject
    {
        /// <summary>
        /// Defines ErrorKey
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ResponseByte" /> class.
        /// </summary>
        /// <param name="Data">Data.</param>
        /// <param name="Success">Success.</param>
        /// <param name="ErrorProperties">ErrorProperties.</param>
        public ResponseByte(byte[] Data = default(byte[]), bool? Success = default(bool?), List<string> ErrorProperties = default(List<string>))
        {
            this.Data = Data;
        ...
        {
            return this.Equals(input as ResponseByte);
        }

        /// <summary>
        /// Returns true if ResponseByte instances are equal
        /// </summary>
        /// <param name="input">Instance of ResponseByte to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResponseByte input)
        {
            if (input == null)
                return false;
