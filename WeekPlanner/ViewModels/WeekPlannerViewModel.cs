...
namespace WeekPlanner.ViewModels
{
	public class WeekPlannerViewModel : ViewModelBase
    {
        ...
        private List<ActivityDTO> _selectedActivities; 
            ...
            : base(navigationService)
        {
            ...
            _selectedActivities = new List<ActivityDTO>();
            _requestService = requestService;
        ...
        private async Task DeSelectActivity(ActivityDTO activity)
        {
        ...
        private async Task ToggleSelectMode()
        {
            if (SelectModeEnabled)
            {
                foreach (ActivityDTO activity in _selectedActivities)
                {
                    // TODO: remove mark 
                }
