...
class GirafButtonLogin extends StatefulWidget {
  /// A button for the Giraf application.
  ...
  @override
  _GirafButtonLoginNewState createState() => _GirafButtonLoginNewState();
}

class _GirafButtonLoginNewState extends State<GirafButtonLogin> {
  @override
  void initState() {
  ...
  static const Gradient _gradientDefault = LinearGradient(
      colors: <Color>[theme.GirafColors.loginButtonColorLight,
        theme.GirafColors.loginButtonColor],
      begin: Alignment(0.0, -1.0),
      end: Alignment(0.0, 1.0));

  static const Gradient _gradientPressed = LinearGradient(
      colors: <Color>[theme.GirafColors.loginButtonColorLightPressed,
        theme.GirafColors.loginButtonColor],
      begin: Alignment(0.0, -1.0),
      end: Alignment(0.0, 1.0));
  ...
  static const Color _borderDefault = theme.GirafColors.gradientGreenBorder;
  static const Color _borderPressed = theme.GirafColors.gradientGreenBorder;
  static const Color _borderDisabled = theme.GirafColors.gradientGreenBorder;
