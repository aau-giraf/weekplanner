                  ...
                  Container(
                      ...
                      child: RichText(text: TextSpan(
                        ...
                        children: <TextSpan>[
                          ...
                          TextSpan(
                              text: '   \u2022 ' 'Navn: Girafs Venner' '\n' '\n',
                              style: TextStyle(fontSize: 20.0)),
                          TextSpan(
                              text: '   \u2022 ' 'Telefon: 40 89 21 56' '\n' '\n',
                              style: TextStyle(fontSize: 20.0)),
                          TextSpan(
                              text: '   \u2022 ' 'CVR-nr.: 40519025' '\n' '\n',
                              style: TextStyle(fontSize: 20.0)),
                          TextSpan(
                              text: '   \u2022 ' 'Mail: ulrik@cs.aau.dk' '\n' '\n',
                              style: TextStyle(fontSize: 20.0)),
                          TextSpan(
                          ...
                          TextSpan(
                              ...
                              style: TextStyle(fontSize: 20.0)),
                          TextSpan(
                              text: '   \u2022 ' 'Ret til berigtigelse (rettelse). Du har ret til at få urigtige oplysninger om dig selv rettet.' '\n' '\n',
                              style: TextStyle(fontSize: 20.0)),
                          TextSpan(
                              text: '   \u2022 ' 'Ret til sletning. I særlige tilfælde har du ret til at få slettet oplysninger om dig, inden tidspunktet for vores almindelige generelle sletning indtræffer.' '\n' '\n',
                              style: TextStyle(fontSize: 20.0)),
                          TextSpan(
                              text: '   \u2022 ' 'Ret til begrænsning af behandling. Du har visse tilfælde ret til at få behandlingen af dine personoplysninger begrænset. Hvis du har ret til at få begrænset behandlingen, må vi fremover kun behandle oplysningerne – bortset fra opbevaring – med dit samtykke, eller med henblik på at retskrav kan fastlægges, gøres gældende eller forsvares, eller for at beskytte en person eller vigtige samfundsinteresser.' '\n' '\n',
                              style: TextStyle(fontSize: 20.0)),
                          TextSpan(
                              text: '   \u2022 ' 'Ret til indsigelse. Du har i visse tilfælde ret til at gøre indsigelse mod vores eller lovlige behandling af dine personoplysninger. Du kan også gøre indsigelse mod behandling af dine oplysninger til direkte markedsføring.' '\n' '\n',
                              style: TextStyle(fontSize: 20.0)),
                          TextSpan(
                              text: '   \u2022 ' 'Ret til at transmittere oplysninger (dataportabilitet). Du har i visse tilfælde ret til at modtage dine personoplysninger i et struktureret, almindeligt anvendt og maskinlæsbart format samt at få overført disse personoplysninger fra én dataansvarlig til en anden uden hindring.' '\n' '\n',
                              style: TextStyle(fontSize: 20.0)),
                          TextSpan(
