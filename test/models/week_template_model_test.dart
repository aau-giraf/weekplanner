...
void main(){
  ...
  test("Should be able to instatiate via JSON", (){
    WeekTemplateModel wtm = WeekTemplateModel.fromJson(response);

    expect(wtm.departmentKey, response['departmentKey']);
    expect(wtm.id, response['id']);
    weekBaseTest(wtm, response);
  });
