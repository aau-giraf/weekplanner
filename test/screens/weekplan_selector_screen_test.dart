...
void main() {
  ...
  void setupApiCalls() {
    ...
    when(weekApi.getNames('testId')).thenAnswer(
        (_) => RxDart.BehaviorSubject<List<WeekNameModel>>.seeded(weekNameModelList));
    ...
    when(weekApi.get(
        ...
        .thenAnswer((_) => RxDart.BehaviorSubject<WeekModel>.seeded(emptyWeekmodel));
    when(weekApi.get(
    ...
    when(weekApi.update(
        ...
        .thenAnswer((_) {
      return RxDart.BehaviorSubject<WeekModel>.seeded(weekModel1Copy);
    });
  ...
  testWidgets(
    ...
    when(weekApi.getNames('testId')).thenAnswer((_) =>
        RxDart.BehaviorSubject<List<WeekNameModel>>.seeded(mockWeekNameModelList));
