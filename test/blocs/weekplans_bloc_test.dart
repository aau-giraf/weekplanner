...
//
  ...
  group('getLastYearsLastWeek', () {
    test('2020 should return 52', async((DoneFn done) {
      final DateTime date = DateTime(2020, 6, 1, 12);

      const int expected = 52;
      final int actual = bloc.getLastYearsLastWeek(date);
    ...
    test('2021 should return 53', async((DoneFn done) {
      final DateTime date = DateTime(2021, 6, 1, 12);
    ...
    test('2022 should return 52', async((DoneFn done) {
      final DateTime date = DateTime(2022, 6, 1, 12);
    ...
    test('2023 should return 52', async((DoneFn done) {
      final DateTime date = DateTime(2023, 6, 1, 12);
    ...
    test('2024 should return 52', async((DoneFn done) {
      final DateTime date = DateTime(2024, 6, 1, 12);
    ...
    test('2025 should return 52', async((DoneFn done) {
      final DateTime date = DateTime(2025, 6, 1, 12);
    ...
    test('2026 should return 52', async((DoneFn done) {
      final DateTime date = DateTime(2026, 6, 1, 12);
    ...
    test('2027 should return 53', async((DoneFn done) {
      final DateTime date = DateTime(2027, 6, 1, 12);
    ...
    test('2028 should return 52', async((DoneFn done) {
      final DateTime date = DateTime(2028, 6, 1, 12);
    ...
    test('2029 should return 52', async((DoneFn done) {
      final DateTime date = DateTime(2029, 6, 1, 12);
    ...
    test('2030 should return 52', async((DoneFn done) {
      final DateTime date = DateTime(2030, 6, 1, 12);
  ...
  group('weekIsLastYearsLastWeek', () {
    group('January 1st is a Friday', () {
      test('Day is Monday, return false', async((DoneFn done) {
        final DateTime date = DateTime(2020, 12, 28, 12);
        ...
        final bool actual = bloc.weekIsLastYearsLastWeek(dayOfYear,
            dayOfWeekJan1);
      ...
      test('Day is Tuesday, return false', async((DoneFn done) {
        final DateTime date = DateTime(2020, 12, 29, 12);
      ...
      test('Day is Wednesday, return false', async((DoneFn done) {
        final DateTime date = DateTime(2020, 12, 30, 12);
      ...
      test('Day is Thursday, return false', async((DoneFn done) {
        final DateTime date = DateTime(2020, 12, 31, 12);
      ...
      test('Day is Friday, return true', async((DoneFn done) {
        final DateTime date = DateTime(2021, 1, 1, 12);
      ...
      test('Day is Saturday, return true', async((DoneFn done) {
        final DateTime date = DateTime(2021, 1, 2, 12);
      ...
      test('Day is Sunday, return true', async((DoneFn done) {
        final DateTime date = DateTime(2021, 1, 3, 12);
      ...
      test('Day is Monday again, return false', async((DoneFn done) {
        final DateTime date = DateTime(2021, 1, 4, 12);
    ...
    group('January 1st is a Saturday', () {
      test('Day is Monday, return false', async((DoneFn done) {
        final DateTime date = DateTime(2021, 12, 27, 12);
      ...
      test('Day is Tuesday, return false', async((DoneFn done) {
        final DateTime date = DateTime(2021, 12, 28, 12);
      ...
      test('Day is Wednesday, return false', async((DoneFn done) {
        final DateTime date = DateTime(2021, 12, 29, 12);
      ...
      test('Day is Thursday, return false', async((DoneFn done) {
        final DateTime date = DateTime(2021, 12, 30, 12);
      ...
      test('Day is Friday, return false', async((DoneFn done) {
        final DateTime date = DateTime(2021, 12, 31, 12);
      ...
      test('Day is Saturday, return true', async((DoneFn done) {
        final DateTime date = DateTime(2022, 1, 1, 12);
      ...
      test('Day is Sunday, return true', async((DoneFn done) {
        final DateTime date = DateTime(2022, 1, 2, 12);
      ...
      test('Day is Monday again, return false', async((DoneFn done) {
        final DateTime date = DateTime(2022, 1, 3, 12);
    ...
    group('January 1st is a Sunday', () {
      test('Day is Monday, return false', async((DoneFn done) {
        final DateTime date = DateTime(2022, 12, 26, 12);
      ...
      test('Day is Tuesday, return false', async((DoneFn done) {
        final DateTime date = DateTime(2022, 12, 27, 12);
      ...
      test('Day is Wednesday, return false', async((DoneFn done) {
        final DateTime date = DateTime(2022, 12, 28, 12);
      ...
      test('Day is Thursday, return false', async((DoneFn done) {
        final DateTime date = DateTime(2022, 12, 29, 12);
      ...
      test('Day is Friday, return false', async((DoneFn done) {
        final DateTime date = DateTime(2022, 12, 30, 12);
      ...
      test('Day is Saturday, return false', async((DoneFn done) {
        final DateTime date = DateTime(2022, 12, 31, 12);
      ...
      test('Day is Sunday, return true', async((DoneFn done) {
        final DateTime date = DateTime(2023, 1, 1, 12);
      ...
      test('Day is Monday again, return false', async((DoneFn done) {
        final DateTime date = DateTime(2023, 1, 2, 12);
    ...
    group('January 1st is a Monday', () {
      test('Day is Friday, return false', async((DoneFn done) {
        final DateTime date = DateTime(2023, 12, 29, 12);
      ...
      test('Day is Saturday, return false', async((DoneFn done) {
        final DateTime date = DateTime(2023, 12, 30, 12);
      ...
      test('Day is Sunday, return false', async((DoneFn done) {
        final DateTime date = DateTime(2023, 12, 31, 12);
      ...
      test('Day is Monday, return false', async((DoneFn done) {
        final DateTime date = DateTime(2024, 1, 1, 12);
  ...
  group('weekIsNextYearsFirstWeek', () {
    group('Days that should not be considered', () {
      test('01/06/2020, return false',
          async((DoneFn done) {
            final DateTime date = DateTime(2020, 6, 1, 12);

            const bool expected = false;
            final bool actual = bloc.weekIsNextYearsFirstWeek(date);
      ...
      test('06/04/2020, return false',
          async((DoneFn done) {
            final DateTime date = DateTime(2025, 4, 6, 12);
    ...
    group('January 1st is a Tuesday', () {
      test('Day is Sunday, return false', async((DoneFn done) {
        final DateTime date = DateTime(2029, 12, 30, 12);
      ...
      test('Day is Monday, return true', async((DoneFn done) {
        final DateTime date = DateTime(2029, 12, 31, 12);
      ...
      test('Day is Tuesday, return false', async((DoneFn done) {
        final DateTime date = DateTime(2030, 1, 1, 12);
      ...
      test('Day is Wednesday, return false', async((DoneFn done) {
        final DateTime date = DateTime(2030, 1, 2, 12);
      ...
      test('Day is Thursday, return false', async((DoneFn done) {
        final DateTime date = DateTime(2030, 1, 3, 12);
    ...
    group('January 1st is a Wednesday', () {
      test('Day is Sunday, return false', async((DoneFn done) {
        final DateTime date = DateTime(2030, 12, 29, 12);
      ...
      test('Day is Monday, return true', async((DoneFn done) {
        final DateTime date = DateTime(2030, 12, 30, 12);
      ...
      test('Day is Tuesday, return true', async((DoneFn done) {
        final DateTime date = DateTime(2030, 12, 31, 12);
      ...
      test('Day is Wednesday, return false', async((DoneFn done) {
        final DateTime date = DateTime(2031, 1, 1, 12);
      ...
      test('Day is Thursday, return false', async((DoneFn done) {
        final DateTime date = DateTime(2031, 1, 2, 12);
    ...
    group('January 1st is a Thursday', () {
      test('Day is Sunday, return false', async((DoneFn done) {
        final DateTime date = DateTime(2031, 12, 28, 12);
      ...
      test('Day is Monday, return true', async((DoneFn done) {
        final DateTime date = DateTime(2031, 12, 29, 12);
      ...
      test('Day is Tuesday, return true', async((DoneFn done) {
        final DateTime date = DateTime(2031, 12, 30, 12);
      ...
      test('Day is Wednesday, return true', async((DoneFn done) {
        final DateTime date = DateTime(2031, 12, 31, 12);
      ...
      test('Day is Thursday, return false', async((DoneFn done) {
        final DateTime date = DateTime(2032, 1, 1, 12);
